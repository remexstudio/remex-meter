...
const KNOWN_CLIENT_ASSETS = new Set([
  'cursor', 'grok', 'claude', 'codex', 'opencode', 'dsh', 'hermes', 'openclaw', 'antigravity', 'cline',
  'amp', 'droid', 'kimi', 'qwen', 'copilot', 'pi', 'omp', 'zed', 'kilo', 'commandcode', 'mimo', 'zcode', 'kiro', 'codebuddy', 'workbuddy', 'proma', 'qodercn', 'reasonix', 'cherrystudio', 'lmstudio', 'unsloth', 'devin',
  'gemini'
]);
const CLIENT_LABELS = {
